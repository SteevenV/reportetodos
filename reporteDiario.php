...
$sql = "SELECT id, azienda, odl, cliente, evo, gdp, router, box, parabola, alimentador, tipo, creado, fecha FROM materiale WHERE fecha LIKE '$queFecha'";
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(271, 10, 'RAPPORTINO MATERIALE ENTRANTE', 1, 10, 'C', 1);
        ...
        $this->SetDrawColor(0, 0, 0); //color de linea  rgb
        $this->Cell(135.5, 6, ' Tecnico: ' . $_POST['tecnico'], 1, 0, 'L', 0);
        $this->Cell(135.5, 6,'Data: ' . $_POST['queFecha'], 1, 0, 'L', 0);
        ...
        $this->Cell(40, 9, 'CLIENTE', 1, 0, 'C', 1);
...
while($fila = $consulta->fetch_assoc()) {
    ...
    $pdf->Cell(40, 9, $fila['cliente'], 1, 0, 'C', 0);
